...
const WORKFLOW_MILESTONES = [
    ...
    { id: 'adjudication', label: 'Adjudication', status: [CLAIM_STATUSES.EXAMINER_REVIEW, CLAIM_STATUSES.LEGAL_REVIEW, CLAIM_STATUSES.COMPLIANCE_REVIEW, CLAIM_STATUSES.UNDERWRITER, CLAIM_STATUSES.BENEFIT_CALC] },
